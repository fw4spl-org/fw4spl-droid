...
#include "visuVTKDroidAdaptor/InteractorStyle.hpp"

fwServicesRegisterMacro( ::fwRenderVTK::IVtkAdaptorService, ::visuVTKDroidAdaptor::InteractorStyle, ::fwData::Object );
